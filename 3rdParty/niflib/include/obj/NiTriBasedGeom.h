...
public:
	...
	/*!
	 * This removes the smallest weights from a mesh so that it meets maximum bone criteria per vertex and triangle and then re-normalizes the result.
	 * \param[in] max_bones_per_tri The maximum number of bones that can affect any one triangle.
	 * \param[in] max_bones_per_vert The maximum number of bones that can affect any one vertex.  
	 */
	NIFLIB_API void ReduceSkinWeights( int max_bones_per_tri = 4, int max_bones_per_vert = 4 );
