...
#region form designer stuff
        ...
        private void InitializeComponent() {
            ...
            this.bSetLastImage = new System.Windows.Forms.Button();
            ...
            // bActive
            // 
            this.bActive.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            this.bActive.Location = new System.Drawing.Point(378, 53);
            ...
            // bSetLastImage
            // 
            this.bSetLastImage.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
            this.bSetLastImage.Location = new System.Drawing.Point(535, 538);
            this.bSetLastImage.Margin = new System.Windows.Forms.Padding(0, 3, 0, 3);
            this.bSetLastImage.Name = "bSetLastImage";
            this.bSetLastImage.Size = new System.Drawing.Size(105, 23);
            this.bSetLastImage.TabIndex = 11;
            this.bSetLastImage.Text = "Set <lastframe>";
            this.bSetLastImage.Click += new System.EventHandler(this.bSetLastImage_Click);
            // 
            // bPreviewChain
            // 
            ...
            this.bPreviewChain.Location = new System.Drawing.Point(512, 53);
            ...
            this.bSetDepthImage.Location = new System.Drawing.Point(325, 538);
            ...
            // bShaderFlags
            // 
            this.bShaderFlags.Location = new System.Drawing.Point(12, 53);
            ...
            this.fileToolStripMenuItem1.Size = new System.Drawing.Size(35, 24);
            ...
            // 
            this.undoToolStripMenuItem.Image = global::MGEgui.Properties.Resources.undo;
            ...
            // 
            this.redoToolStripMenuItem.Image = global::MGEgui.Properties.Resources.redo;
            ...
            // 
            this.cutToolStripMenuItem.Image = global::MGEgui.Properties.Resources.cut;
            ...
            // 
            this.copyToolStripMenuItem.Image = global::MGEgui.Properties.Resources.copy;
            ...
            // 
            this.pasteToolStripMenuItem.Image = global::MGEgui.Properties.Resources.paste;
            ...
            this.Controls.Add(this.bSetLastImage);
        ...
        private Button bSetLastImage;
        private Button bPreviewChain;
        private Button bSetDepthImage;
        private OpenFileDialog OpenShader;
        private SaveFileDialog SaveShader;
        ...
        public static void ImportOldShaders() {
            FileStream fs=null;
            try {
                fs=File.OpenRead("effects.sav");
                ArrayList Techniques=(ArrayList)Statics.formatter.Deserialize(fs);
                fs.Close();
                foreach(Technique tec in Techniques) {
                    if(File.Exists(Statics.runDir + "\\Data files\\shaders\\default\\"+tec.Name+".fx")) continue;
                    StreamWriter sw = new StreamWriter(File.Open(Statics.runDir + "\\Data files\\shaders\\default\\" + tec.Name + ".fx", FileMode.CreateNew));
                    sw.WriteLine("texture thisframe;");
                    sw.WriteLine("texture lastframe;");
                    sw.WriteLine("texture lastpass;");
                    sw.WriteLine();
                    for(int i=0;i<tec.Lines.Length;i++) {
                        sw.WriteLine(tec.Lines[i]);
                    }
                    sw.Close();
                }
            } catch(Exception ex) {
                MessageBox.Show("An error occurred while importing your old shader files.\n"+
                    "Some shaders may not have been imported correctly.\n"+
                    ex.Message,"Error");
            } finally {
                if(fs!=null) fs.Close();
                if(File.Exists("effects.sav")) File.Delete("effects.sav");
                if(File.Exists("effects.fx")) File.Delete("effects.fx");
            }
        }
        ...
        public ShaderEditorForm() {
            ...
            //    if(path.EndsWith(".fx")) cmbTechnique.Items.Add(Path.GetFileNameWithoutExtension(path));
            //}
        }

        private bool Validate(IntPtr handle,bool Render) {
            tbMessage.Text = "Compiling...";
            tbMessage.Refresh();
            bool result=false;
            ...
            if (ShaderModified || FullFileName == null) {
                ...
                error = DirectX.Shaders.CompileShader(Render, PicPath, PicPath2, PicPath3, tempfile);

                File.Delete(tempfile);
            } else {
                error = DirectX.Shaders.CompileShader(Render, PicPath, PicPath2, PicPath3, FullFileName);
            }

            if(error==null) {
                tbMessage.Text="Compile successful";
                result=true;
            } else {
        ...
        private void bSetImage_Click(object sender, EventArgs e) {
            OpenImage.FileName = (PicPath == null) ? Statics.runDir+"\\mge3\\preview.bmp" : PicPath;
            if(OpenImage.ShowDialog()==DialogResult.OK) {
                PicPath = OpenImage.FileName;
            }
        }

        private void bSetLastImage_Click(object sender, EventArgs e) {
            OpenImage.FileName = (PicPath2 == null) ? Statics.runDir + "\\mge3\\preview.bmp" : PicPath2;
            if(OpenImage.ShowDialog()==DialogResult.OK) {
                PicPath2 = OpenImage.FileName;
            }
        }

        private void bSetDepthImage_click(object sender, EventArgs e) {
            OpenImage.FileName = (PicPath3 == null) ? Statics.runDir + "\\mge3\\depth.bmp" : PicPath3;
            if (OpenImage.ShowDialog() == DialogResult.OK) {
                PicPath3 = OpenImage.FileName;
            }
        }
        ...
        private void bShaderNew_Click(object sender, EventArgs e) {
            if (ShaderModified) {
                DialogResult res = MessageBox.Show("Save current shader file?", "Save", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
        ...
        private void bShaderFlags_Click(object sender, EventArgs e) {
            ...
            if (m.Success) {
                try {
                    ...
                    MessageBox.Show("Could not read shader flags. Something may be wrong with the code.", "Error");
                    return;
                }
            }
