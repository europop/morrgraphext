//Author: Timeslip
//A bloom shader chain combined into a single technique for greater efficency
...
float4 VertBloom( float2 Tex : TEXCOORD0 ) : COLOR0
{
    float4 Color = 0;
...
float4 HorizBloom( float2 Tex : TEXCOORD0 ) : COLOR0
{
    float4 Color = 0;
...
technique T0
{
    ...
    pass p3
    {
        PixelShader = compile ps_2_0 HorizBloom();
    }
    pass p4
    {
