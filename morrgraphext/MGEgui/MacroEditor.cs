...
#region FormDesigner
        ...
        private List<MacroFunc> macroFuncData = new List<MacroFunc> {
            ...
            new MacroFunc(10, "Rotate screen"),
            new MacroFunc(1, "Toggle fog"),
            new MacroFunc(2, "Cycle scale filter"),
            new MacroFunc(3, "Cycle mip filter"),
            new MacroFunc(4, "Cycle fog mode"),
            new MacroFunc(5, "Toggle antialiasing"),
            new MacroFunc(6, "Cycle filter level"),
            new MacroFunc(15, "Increase fogging"),
            new MacroFunc(16, "Decrease fogging"),
            new MacroFunc(17, "Toggle alt combat"),
            new MacroFunc(18, "Delete quicksave"),
            new MacroFunc(19, "Delete autosave"),
            new MacroFunc(20, "Toggle AA fix"),
            new MacroFunc(23, "Increase AI range"),
            new MacroFunc(24, "Decrease AI range"),
            new MacroFunc(25, "Increase mipmap LOD"),
            new MacroFunc(26, "Decrease mipmap LOD"),            
            new MacroFunc(47, "Toggle sky reflection"),
        };
