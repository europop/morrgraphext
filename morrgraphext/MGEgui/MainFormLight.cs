...
namespace MGEgui {
    ...
    public partial class MainFormLight : Form {
        ...
        public MainFormLight (bool AutoLang) {
            ...
            // Title
            Text = "Morrowind Graphics Extender (" + Statics.versionString + ")" + " Light version";
        ...
        private void LoadSettings () {
            RegistryKey key = Statics.reg_key_bethesda.CreateSubKey(Statics.reg_morrowind);
            int width, height;
            try {
        ...
        private void cbUILangAuto_CheckedChanged (object sender, EventArgs e) {
            ...
            if (status) {
                ...
                foreach (System.Globalization.CultureInfo culture in LocalizationInterface.UserLanguages) {
                    index = cmbUILanguage.FindStringExact(LocalizationInterface.SysLang(culture));
        ...
        private void bFullVersion_Click(object sender, EventArgs e) {
