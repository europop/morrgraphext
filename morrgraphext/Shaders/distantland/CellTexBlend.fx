...
Technique T0
{
	Pass P0
	{
		...
		VertexShader = compile vs_2_0 CellTexBlendVS();
		PixelShader = compile ps_2_0 CellTexBlendPS();
	}
	Pass P1
	{
		...
		VertexShader = compile vs_2_0 CellNormalMapVS();
		PixelShader = compile ps_2_0 CellNormalMapPS();
	}
	Pass P2
	{
		AlphaBlendEnable = true;
		...
		VertexShader = compile vs_2_0 CellVertColorVS();
		PixelShader = compile ps_2_0 CellVertColorPS();
	}
}
