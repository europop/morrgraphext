...
typedef enum {
	...
	,ADDSPELL=		0x3FA0		// fixed from 0x3F20
	,REMOVESPELL=	0x3FA1			// fixed from 0x3F21
	...
	,WIPEALL=       0x3700
	,OUTPUTDEBUGSTRING=0x3701
	,OUTPUTVERSIONSTRING=0x3702
	,GETVERSION=    0x3703
	,GETWIDTH=      0x3704
	,GETHEIGHT=     0x3705
	,GETFPS=        0x3706
	,GETEYEVEC=     0x3707
	,ENABLEDISTANTLAND=0x3708
	,DISABLEDISTANTLAND=0x3709
	,WIPEHUDELEMENTS=0x370a
	,WITHHUD=       0x370b
	,CANCELWITHHUD= 0x370c
	,LOADHUD=       0x370d
	,POSITIONHUD=   0x370e
	,SCALEHUD=      0x370f
	,FULLSCREENHUD= 0x3710
	,ENABLEHUD=     0x3711
	,DISABLEHUD=    0x3712
	,CHANGEHUDTEXTURE=0x3713
	,CHANGEHUDEFFECT=0x3714
	,FREEHUD=       0x3715
	,NIDLOADHUD=    0x3716
	,NIDPOSITIONHUD=0x3717
	,NIDSCALEHUD=   0x3718
	,NIDFULLSCREENHUD=0x3719
	,NIDENABLEHUD=  0x371a
	,NIDDISABLEHUD= 0x371b
	,NIDCHANGEHUDTEXTURE=0x371c
	,NIDCHANGEHUDEFFECT=0x371d
	,NIDFREEHUD=    0x371e
	,MANUALLIGHTING=0x371f
	,ENDMANUALLIGHTING=0x3720
	,SETSUNCOLOUR=  0x3721
	,DEFAULTSUNCOLOUR=0x3722
	,SETSUNDIRECTION=0x3723
	,DEFAULTSUNDIRECTION=0x3724
	,SETSUNTEXTURE= 0x3725
	,DEFAULTSUNTEXTURE=0x3726
	,GETSUNCOLOUR=  0x3727
	,GETSUNDIR=     0x3728
	,SETAMBIENTCOLOUR=0x3729
	,DEFAULTAMBIENTCOLOUR=0x372a
	,GETAMBIENTCOLOUR=0x372b
	,SETCLSCOLOR=   0x372c
	,DEFAULTCLSCOLOUR=0x372d
	,GETCLSCOLOUR=  0x372e
	,SETSKYCOLOUR=  0x372f
	,DEFAULTSKYCOLOUR=0x3730
	,SETHUDCOLOUR=  0x3731
	,DEFAULTHUDCOLOUR=0x3732
	,TAPKEY=        0x3733
	,PUSHKEY=       0x3734
	,RELESEKEY=     0x3735
	,HAMMERKEY=     0x3736
	...
	,DISALLOWKEY=   0x373a
	,ALLOWKEY=      0x373b
	,MOVEMOUSERIGHT=0x373c
	,MOVEMOUSELEFT= 0x373d
	,MOVEMOUSEUP=   0x373e
	,MOVEMOUSEDOWN= 0x373f
	,SETMOUSESPEEDRIGHT=0x3740
	,SETMOUSESPEEDLEFT=0x3741
	,SETMOUSESPEEDUP=0x3742
	,SETMOUSESPEEDDOWN=0x3743
	,DISABLEMOUSE=  0x3744
	,ENABLEMOUSE=   0x3745
	,BUFFEREDKEYDOWN=0x3746
	,BUFFEREDKEYUP= 0x3747
	,ENABLEFOG=     0x3748
	,DISABLEFOG=    0x3749
	,TOGGLEFOG=     0x374a
	,INCREASEFOG=   0x374b
	,DECREASEFOG=   0x374c
	,INCREASEFOGBY= 0x374d
	,DECREASEFOGBY= 0x374e
	,SETFOG=        0x374f
	,FOGZOOM=       0x3750
	,STOPFOGZOOM=   0x3751
	,GETFOG=        0x3752
	,SETFOGCOLOUR=  0x3753
	,DEFAULTFOGCOLOUR=0x3754
	,GETFOGCOLOUR=  0x3755
	,ENABLECAMERASHAKE=0x3756
	,DISABLECAMERASHAKE=0x3757
	,SETCAMERASHAKEMAGNITUDE=0x3758
	,CAMERASHAKEZOOM=0x3759
	,STOPCAMERASHAKEZOOM=0x375a
	,TAKESCREENSHOT=0x375b
	,TAKEBMPSCREENSHOT=0x375c
	,TAKEJPEGSCREENSHOT=0x375d
	,TAKEDDSSCREENSHOT=0x375e
	,TAKEPNGSCREENSHOT=0x375f
	,ENABLEFPSCOUNTER=0x3760
	,DISABLEFPSCOUNTER=0x3761
	,TOGGLEFPSCOUNTER=0x3762
	,ROTATESCREEN=  0x3763
	,SETSCREENROT0= 0x3764
	,SETSCREENROT90=0x3765
	,SETSCREENROT180=0x3766
	,SETSCREENROT270=0x3767
	,ROTATESCREENBY=0x3768
	,SETSCREENROTATION=0x3769
	,SCREENSPIN=    0x376a
	,STOPSPINSPIN=  0x376b
	,GETSCREENROTATION=0x376c
	,ENABLEZOOM=    0x376d
	,DISABLEZOOM=   0x376e
	,TOGGLEZOOM=    0x376f
	,ZOOMIN=        0x3770
	...
	,BEGINTEXDRAW=  0x377b
	,ENDTEXDRAW=    0x377c
	,SETTEXDRAWORIGIN=0x377d
	,SETTEXDRAWSCALE=0x377e
	,SETTEXDRAWCOLOUR=0x377f
	,DRAWTEXTTOTEXTURE=0x3780
	,DRAWTEXTURETOTEXTURE=0x3781
	,AUTOFREEHOOK=  0x3782
	,DONTFREEHOOK=  0x3783
	,RESUMEVIDEO=   0x3784
	,PAUSEVIDEO=    0x3785
	...
	,REWINDVIDEO=   0x3787
	,SEEKVIDEO=     0x3788
	,ENABLEFULLSCREENSHADER=0x3789
	,DISABLEFULLSCREENSHADERS=0x378a
	,TOGGLEFULLSCREENSHADERS=0x378b
	,LOADEFFECT=    0x378c
	,SETEFFECTTECHNIQUE=0x378d
	,USEEFFECTASFULLSCREENSHADER=0x378e
	,DISABLEEFFECTASFULLSCREENSHADER=0x378f
	,FREEEFFECT=    0x3790
	,SETEFFECTVARLONG=0x3791
	,SETEFFECTVARFLOAT=0x3792
	,SETEFFECTVARVECTOR=0x3793
	,SETEFFECTVARTEXTURE=0x3794
	,WIPELOADEDEFFECTS=0x3795
	,WITHMESH=      0x3796
	,CANCELWITHMESH=0x3797
	,WIPELOADEDMESHES=0x3798
	,LOADMESH=      0x3799
	,SETMESHPOSITION=0x379a
	,SETMESHROTATION=0x379b
	,SETMESHSCALE=  0x379c
	,MOVEMESH=      0x379d
	,ROTATEMESH=    0x379e
	,SCALEMESH=     0x379f
	,SETMESHVELOCITY=0x37a0
	,SETMESHANGULARVELOCITY=0x37a1
	,SETMESHGROWTH= 0x37a2
	,ZEROMESHVELOCITY=0x37a3
	,ZEROMESHANGULARVELOCITY=0x37a4
	,ZEROMESHGROWTH=0x37a5
	,ENABLEMESH=    0x37a6
	,DISABLEMESH=   0x37a7
	,SETMESHTEXTURE=0x37a8
	,SETMESHEFFECT= 0x37a9
	,MANUALMESH=    0x37aa
	,FREEMESH=      0x37ab
	,UPDATEMESHLIGHTING=0x37ac
	,NIDLOADMESH=   0x37ad
	,NIDSETMESHPOSITION=0x37ae
	,NIDSETMESHROTATION=0x37af
	,NIDSETMESHSCALE=0x37b0
	,NIDMOVEMESH=   0x37b1
	,NIDROTATEMESH= 0x37b2
	,NIDSCALEMESH=  0x37b3
	,NIDSETMESHVELOCITY=0x37b4
	,NIDSETMESHANGULARVELOCITY=0x37b5
	,NIDSETMESHGROWTH=0x37b6
	,NIDZEROMESHVELOCITY=0x37b7
	,NIDZEROMESHANGULARVELOCITY=0x37b8
	,NIDZEROMESHGROWTH=0x37b9
	,NIDENABLEMESH= 0x37ba
	,NIDDISABLEMESH=0x37bb
	,NIDSETMESHTEXTURE=0x37bc
	,NIDSETMESHEFFECT=0x37bd
	,NIDMANUALMESH= 0x37be
	,NIDFREEMESH=   0x37bf
	,NIDUPDATEMESHLIGHTING=0x37c0
	} OPCODES;
